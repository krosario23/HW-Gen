...
You upload a PDF template — a homework sheet that has a "Name:" field somewhere on it.
You provide a list of student names — entered as text, one per line.
The app generates one copy of the PDF per student, automatically replacing the "Name:" placeholder with each student's actual name.
It bundles all the copies into a single PDF and sends it back to you as a download.
